...
for model_eval in model_eval_pool:
    ...
    for it in range(1, args.num_intervals+1):
        ...
        experiment_name = f'{args.dataset}_{args.model}_{args.eval_mode}_ipc{args.ipc}_min{max_start_epoch-args.max_start_epoch}_max{max_start_epoch}_syn{args.syn_steps}_real{args.expert_epochs}_img{args.lr_img}_{args.lr_lr}_{args.lr_teacher}'
        if args.zca:
            experiment_name += '_zca'
    ...
    if model_eval == args.model:
        ...
        save_dir = os.path.join(args.save_path, args.dataset, experiment_name)

        for it_buffer in range(0, args.num_experts):

            teacher_net = net_eval_pool[model_eval][it_buffer]
            teacher_net.train()
            lr = args.lr_teacher
            ...
            for e in range(args.max_start_epoch+args.expert_epochs+1):
                ...
                print("Itr: {}\tEpoch: {}\tTrain Acc: {}\tTest Acc: {}".format(it_buffer, e, train_acc, test_acc))
